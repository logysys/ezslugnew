...
export default function HandleSellInvoice() {
    ...
    return (
        <>
            <Head>
                <title>{`Invoice ${invoice.invoice_number} - Handle Sale`}</title>
                <meta name="description" content={`Invoice for your handle sale - ${invoice.invoice_number}`} />
                {blurStyle}
            </Head>
