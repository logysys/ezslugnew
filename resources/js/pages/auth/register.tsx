...
export default function Register() {
    // Get the tooltips from page props
    ...
    // Get tooltips from props or use defaults as fallback
    ...
    // Function to get tooltip text by index
    const getTooltip = (index: number): string => {
        return authTooltips[index] || authTooltips[0]; // Fallback to first tooltip if index doesn't exist
    };
        ...
        <AuthLayout title="Create an account" description="Enter your details below to create your account">
            ...
            {showTermsModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="relative max-w-4xl max-h-[70vh] overflow-y-auto">
            ...
            <form className="flex flex-col gap-6" onSubmit={submit}>
                <div className="grid gap-6">
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            data-tooltip-content={getTooltip(12)} // "Enter your full name"
                        />
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            data-tooltip-id="auth-tooltip"
                            data-tooltip-content={getTooltip(13)} // "Enter a valid email address"
                        />
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            data-tooltip-id="auth-tooltip"
                            data-tooltip-content={getTooltip(14)} // "Choose a strong password"
                        />
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            data-tooltip-id="auth-tooltip"
                            data-tooltip-content={getTooltip(15)} // "Re-enter your password to confirm"
                        />
                    ...
                    <div className="flex items-start space-x-3 py-2">
                        ...
                        <Label htmlFor="agree_to_terms" className="text-sm leading-normal">
                            ...
                            <button 
                                ...
                                tabIndex={6}
                                data-tooltip-id="auth-tooltip"
                                data-tooltip-content={getTooltip(4)} // "Read the Terms and Conditions"
                            >
                            ...
                            <button 
                                ...
                                tabIndex={7}
                                data-tooltip-id="auth-tooltip"
                                data-tooltip-content={getTooltip(5)} // "Read the Privacy Policy"
                            >
                                Privacy Policy
                            </button>
                        </Label>
                    ...
                    <Button 
                        ...
                        disabled={processing}
                        data-tooltip-id="auth-tooltip"
                        data-tooltip-content={getTooltip(16)} // "Complete registration and create your account"
                    >
                ...
                <div className="text-muted-foreground text-center text-sm">
                    ...
                    <TextLink 
                        ...
                        tabIndex={9}
                        data-tooltip-id="auth-tooltip"
                        data-tooltip-content={getTooltip(17)} // "Go to the login page"
                    >
                        Log in
                    </TextLink>
                </div>
