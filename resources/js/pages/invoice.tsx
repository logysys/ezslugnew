...
export default function Invoice() {
    ...
    return (
        <>
            <Head>
                <title>{`Invoice ${invoice.invoice_number} - Bee Points Purchase`}</title>
                <meta name="description" content={`Invoice for your Bee Points purchase - ${invoice.invoice_number}`} />
                {blurStyle}
            </Head>
                ...
                <div className="relative z-10">
                    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className="mb-8">
                                <h2 className="text-lg font-medium text-gray-900 mb-4">Bee Points Purchased</h2>
