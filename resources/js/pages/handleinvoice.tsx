...
export default function HandleInvoice() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center p-8 bg-white rounded-lg shadow-md">
                    ...
                    <Link 
                        href="/handlepurchasehistory" 
                        className="text-blue-600 hover:text-blue-800"
                    >
                        Back to Handle Purchase History
                    </Link>
                </div>
            </div>
        );
    ...
    return (
        <>
            <Head>
                <title>{`Invoice ${invoice.invoice_number} - Handle Purchase`}</title>
                <meta name="description" content={`Invoice for your handle purchase - ${invoice.invoice_number}`} />
                {blurStyle}
            </Head>
