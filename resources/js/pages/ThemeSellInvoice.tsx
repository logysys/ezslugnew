...
export default function ThemeSellInvoice() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center p-8 bg-white rounded-lg shadow-md">
                    ...
                    <Link 
                        href="/seller/theme-history" 
                        className="text-blue-600 hover:text-blue-800"
                    >
                        Back to Theme History
                    </Link>
                </div>
            </div>
        );
    ...
    const handlePrint = () => {
        ...
        if (printWindow) {
            printWindow.document.write(`
                ...
                <html>
                <head>
                    <title>Invoice ${invoice.invoice_number} - Theme Sale</title>
                    <style>
                        ...
                        .earnings-breakdown { background: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0; }
                    </style>
                </head>
                <body>
                    ...
                    <div class="invoice-body">
                        ...
                        <div style="margin-bottom: 20px;">
                            <p><strong>Theme:</strong> ${invoice.theme.title}</p>
                            <p><strong>Theme ID:</strong> ${invoice.theme.unique_id}</p>
                            <p><strong>Price:</strong> ${invoice.theme.price} EZ$</p>
                            ${invoice.theme.description ? `<p><strong>Description:</strong> ${invoice.theme.description}</p>` : ''}
                        </div>

                        <h2>Parties Involved</h2>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 30px;">
                            <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">
                                <h3 style="font-size: 14px; color: #666; margin: 0 0 10px 0;">Buyer</h3>
                                <p><strong>Name:</strong> ${invoice.buyer.name}</p>
                                <p><strong>Email:</strong> ${invoice.buyer.email}</p>
                            </div>
                            <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">
                                <h3 style="font-size: 14px; color: #666; margin: 0 0 10px 0;">Seller</h3>
                        ...
                        <div class="earnings-breakdown">
                            ...
                            <p><strong>Total Sale:</strong> ${invoice.transaction.amount} EZ$</p>
                            <p><strong>Seller Earnings:</strong> ${invoice.transaction.seller_amount} EZ$</p>
                            <p><strong>Platform Commission:</strong> ${invoice.transaction.commission} EZ$</p>
                        </div>
    ...
    return (
        <>
            <Head>
                <title>{`Invoice ${invoice.invoice_number} - Theme Sale`}</title>
                <meta name="description" content={`Invoice for your theme sale - ${invoice.invoice_number}`} />
                {blurStyle}
            </Head>
                ...
                <div className="relative z-10">
                    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className="mb-8">
                                <h2 className="text-lg font-medium text-gray-900 mb-4">Theme Details</h2>
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <div className="flex items-start">
                                        <FontAwesomeIcon icon={faCube} className="text-purple-500 mt-1 mr-3" />
                                        <div className="flex-1">
                                            <h3 className="font-medium text-gray-900">{invoice.theme.title}</h3>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                                <div>
                                                    <p className="text-sm text-gray-500">Theme ID</p>
                                                    <p className="font-medium">{invoice.theme.unique_id}</p>
                                                </div>
                                                <div>
                                                    <p className="text-sm text-gray-500">Price</p>
                                                    <p className="font-medium">{invoice.theme.price} EZ$</p>
                                                </div>
                                            </div>
                                            {invoice.theme.description && (
                                                <div className="mt-2">
                                                    <p className="text-sm text-gray-500">Description</p>
                                                    <p className="text-sm text-gray-700">{invoice.theme.description}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                            ...
                            <div className="mb-8">
                                <h2 className="text-lg font-medium text-gray-900 mb-4">Earnings Breakdown</h2>
                                <div className="bg-gradient-to-r from-yellow-50 to-green-50 p-4 rounded-lg border border-yellow-200">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div className="text-center">
                                            ...
                                            <p className="text-lg font-bold text-gray-900">{invoice.transaction.amount} EZ$</p>
                                        </div>
                                        <div className="text-center">
                                            <p className="text-sm text-gray-500 flex items-center justify-center">
                                                <FontAwesomeIcon icon={faMoneyBillWave} className="mr-1 text-yellow-500" />
                                                Seller Earnings
                                            </p>
                                            <p className="text-lg font-bold text-yellow-600">{invoice.transaction.seller_amount} EZ$</p>
                                        </div>
                                        <div className="text-center">
                                            <p className="text-sm text-gray-500 flex items-center justify-center">
                                                <FontAwesomeIcon icon={faPercentage} className="mr-1 text-red-500" />
                                                Platform Commission
                                            </p>
                                            <p className="text-lg font-bold text-red-600">{invoice.transaction.commission} EZ$</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
