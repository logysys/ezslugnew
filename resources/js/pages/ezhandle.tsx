        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6">
                <button
                    ...
                    data-tooltip-id="ezhandle-tooltip"
                    data-tooltip-content="Confirm and pay"
                >
                    {isProcessing ? (
                        <>
...
export default function EzHandle() {
    ...
    const checkHandleAvailability = async () => {
        ...
        try {
            ...
            const response = await axios.post('/check-handle-availability', {
                domain: selectedDomain,
                handle: customHandle,
    ...
    const initiateHandlePayment = async () => {
        ...
        let payloadPromoPrice = paymentInfo.promoPrice;
        let payloadCouponCode = paymentInfo.couponCode;
        const finalPriceInUsd = paymentInfo.buyingPrice * beePrice;

        if (finalPriceInUsd > 0 && finalPriceInUsd < 1.00) {
            // Calculate the bee equivalent for $1.00 to send to the backend
            const minPriceInBee = 1.00 / beePrice;
            payloadPromoPrice = minPriceInBee;
            // Clear coupon to prevent the backend from applying a discount on our new minimum price
            payloadCouponCode = '';
        }
        try {
            const response = await axios.post('/initiate-handle-payment', {
                price: paymentInfo.price,
                email: email,
                custom_handle: customHandle,
                domain: selectedDomain,
                promo_price: payloadPromoPrice,
    ...
    const handlePaymentSuccess = async () => {
        ...
        try {
            const response = await axios.post('/handle-success', {
            ...
            if (response.data.success) {
                setSuccessMessage(`Handle purchased successfully! Your new URL: https://${selectedDomain}/${customHandle}`);
    ...
    const handleSubmitCustomHandle = async (e: React.FormEvent) => {
        ...
        const priceToShow = (paymentInfo.promoPrice === 0 && !paymentInfo.couponValid)
            ? paymentInfo.price
            : paymentInfo.buyingPrice;
            
        const usdPrice = priceToShow * beePrice;
        ...
        try {
            ...
            const response = await axios.post(`/update-ez-funnel-handle/${selectedFunnel.id}`, payload);
    ...
    return (
        <>
            <Head>
                <title>EZ Handle - Custom URLs for Your Funnels</title>
                {blurStyle}
                <style>{`
                    .react-tooltip {
                                ...
                                {funnels.map((funnel) => (
                                    <div key={funnel.id} className="flex items-center p-4 gap-1 bg-[#5d0f6e] rounded-lg">
                                        ...
                                        <button
                                            ...
                                            data-tooltip-id="ezhandle-tooltip"
                                            data-tooltip-content="Add or edit the custom handle for this funnel"
                                        >
                                            Add Custom Handle
                                        </button>
                                    </div>
                                ...
                                <div className="bg-gray-800/80 border border-gray-700 rounded-lg p-6 space-y-4">
                                    <div className="flex justify-between items-center">
                                        <h2 className="text-xl font-bold text-white">
                                            ...
                                            Custom Handle for: {selectedFunnel?.token}
                                        </h2>
                                        <button
                                            onClick={() => {
                                                setIsHandleFormOpen(false);
                                    ...
                                    <form onSubmit={handleSubmitCustomHandle} className="space-y-4">
                                        <div className="space-y-2">
                                            <label className="text-yellow-400 font-medium">New Custom Handle</label>
                                            <div className="flex items-center bg-gray-700 border border-gray-600 rounded-lg overflow-hidden">
                                                <select
                                                    ...
                                                    data-tooltip-id="ezhandle-tooltip"
                                                    data-tooltip-content="Select the domain for your custom handle"
                                                >
                                                    {domains?.map((domain) => (
                                                ...
                                                <input
                                                    ...
                                                    data-tooltip-id="ezhandle-tooltip"
                                                    data-tooltip-content="Enter your desired handle (3-32 characters, letters, numbers, hyphens)"
                                                />
                                                <button
                                                    type="button"
                                                    className={`px-4 py-2 ${
                                            ...
                                            <div className="mt-6 bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                                                ...
                                                <div className="mb-4">
                                                    <p className="text-white">
                                                        {paymentInfo.domain}/{paymentInfo.handle}
                                                    </p>
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <div className="flex gap-2 mt-1">
                                                        <button
                                                            ...
                                                            data-tooltip-id="ezhandle-tooltip"
                                                            data-tooltip-content="Pay with Bee currency"
                                                        >
                                                            EZ$
                                                        </button>
                                                        <button
                                                ...
                                                <div className="space-y-3">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            data-tooltip-id="ezhandle-tooltip"
                                                            data-tooltip-content="Enter a coupon code to get a discount"
                                                        />
                                                    </div>
                                                    {paymentInfo.couponCode && (
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            data-tooltip-id="ezhandle-tooltip"
                                                            data-tooltip-content="Name Your Price: Set a price to list this handle in the marketplace for others to buy"
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <button
                                                    ...
                                                    disabled={isSubmitting}
                                                    data-tooltip-id="ezhandle-tooltip"
                                                    data-tooltip-content="Complete the purchase of this handle"
                                                >
                                                    {isSubmitting ? 'Processing...' : (() => {
                                                        ...
                                                        if (paymentMethod === 'bee') {
                                                            return `Buy Handle for EZ$${priceToShow.toFixed(2)}`;
                                                        } else {
                                                            const finalUsdAmount = priceToShow * beePrice;
                                                            return `Buy Handle for US${(finalUsdAmount > 0 && finalUsdAmount < 1 ? 1.00 : finalUsdAmount).toFixed(2)}`;
                                                        }
                                                    })()}
                                                </button>
                                            </div>
                                ...
                                <div className="bg-gray-800/80 border border-gray-700 rounded-lg p-6 flex flex-col items-center justify-center h-full">
                                    <div className="text-center max-w-md">
                                        ...
                                        <p className="text-gray-300 mb-6">
                                            Select a funnel from the list to assign or update its custom handle.
                                            Custom handles make your funnel URLs more memorable and branded.
                                        </p>
                                        <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700 text-left">
                                            ...
                                            <ul className="text-gray-300 text-sm space-y-1">
                                                <li>• ez.wiki/<span className="text-white">yourbrand</span></li>
                                                <li>• ez.wiki/<span className="text-white">product-name</span></li>
                                                <li>• ez.wiki/<span className="text-white">company-2023</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="fixed inset-0 bg-black/70 min-h-screen flex items-center justify-center z-[100] p-4 overflow-y-auto">
                        <div className="bg-[#235A72] border border-[#3a7a94] text-white p-8 rounded-lg shadow-lg max-w-sm w-full relative max-h-[90vh] overflow-y-auto">
                            <button
                                ...
                                disabled={isLoading}
                                data-tooltip-id="ezhandle-tooltip"
                                data-tooltip-content="Close Payment"
                            >
                                ...
                                {paymentStep === 1 ? (
                                    <>
                                        <div className="text-center">
                                            ...
                                            <p className="text-[#a8d0e6]">You'll be charged US${(paymentInfo.buyingPrice * beePrice > 0 && paymentInfo.buyingPrice * beePrice < 1 ? 1.00 : paymentInfo.buyingPrice * beePrice).toFixed(2)}</p>
                                        </div>
                                        ...
                                        <div className="mt-6">
                                            <div className="flex items-center bg-white rounded-md">
                                                ...
                                                <input
                                                    ...
                                                    disabled={isLoading}
                                                    data-tooltip-id="ezhandle-tooltip"
                                                    data-tooltip-content="Enter your email for the receipt"
                                                />
                                            </div>
                                        ...
                                        <div className="mt-6">
                                            <button
                                                ...
                                                data-tooltip-id="ezhandle-tooltip"
                                                data-tooltip-content="Proceed to the payment step"
                                            >
                                                {isLoading ? (
                                                    <>
                                                        <FontAwesomeIcon icon={faSpinner} className="animate-spin mr-2" />
                                    ...
                                    >
                                        {clientSecret ? (
                                            <StripeCheckoutForm
                                                price={(paymentInfo.buyingPrice * beePrice > 0 && paymentInfo.buyingPrice * beePrice < 1 ? 1.00 : paymentInfo.buyingPrice * beePrice)}
                                                email={email}
                                                clientSecret={clientSecret}
