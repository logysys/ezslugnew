...
export default function ThemeInvoice() {
    ...
    // Add the renderTemplateContent function from your existing components here
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center p-8 bg-white rounded-lg shadow-md">
                    ...
                    <Link 
                        href="/themepurchasehistory" 
                        className="text-blue-600 hover:text-blue-800"
                    >
                        Back to Theme Purchase History
                    </Link>
                </div>
            </div>
        );
            ...
            printWindow.document.write(`
                ...
                <body>
                    ...
                    <div class="invoice-body">
                            ...
                            <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">
                                ...
                                <div style="display: flex; align-items: center;">
                                    <span style="font-weight: bold; text-transform: capitalize;">
                                        ${invoice.transaction.payment_method} ${invoice.transaction.last4}
                                    </span>
                                </div>
                            </div>
                            <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">
                        ...
                        <h2>Theme Purchased</h2>
                        <div style="margin-bottom: 20px;">
                            ${invoice.theme ? `
                                <p><strong>Title:</strong> ${invoice.theme.title}</p>
                                <p><strong>Theme ID:</strong> ${invoice.theme.unique_id}</p>
                                <p><strong>Price:</strong> ${invoice.transaction.payment_method === 'Bee Points' ? `${invoice.theme.price} EZ$` : `$${invoice.theme.price}`}</p>
                                ${invoice.theme.description ? `<p><strong>Description:</strong> ${invoice.theme.description}</p>` : ''}
                            ` : '<p>Theme details not available</p>'}
                        </div>
                            ...
                            <tbody>
                                ${invoice.items.map(item => `
                                    <tr>
                                        ...
                                        <td>${invoice.transaction.payment_method === 'Bee Points' ? `${item.unit_price} EZ$` : `$${item.unit_price}`}</td>
                                        <td>${invoice.transaction.payment_method === 'Bee Points' ? `${item.amount} EZ$` : `$${item.amount}`}</td>
                                    </tr>
                                `).join('')}
                            </tbody>
                            <tfoot>
                                <tr class="total-row">
                                    ...
                                    <td>${invoice.transaction.payment_method === 'Bee Points' ? `${invoice.amount} EZ$` : `$${invoice.amount}`}</td>
                                </tr>
                            </tfoot>
                        </table>
    ...
    return (
        <>
            <Head>
                <title>{`Invoice ${invoice.invoice_number} - Theme Purchase`}</title>
                <meta name="description" content={`Invoice for your theme purchase - ${invoice.invoice_number}`} />
                {blurStyle}
            </Head>
                ...
                <div className="relative z-10">
                    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-6 md:p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div className="flex items-center">
                                            <FontAwesomeIcon 
                                                icon={invoice.transaction.payment_method === 'Bee Points' ? faCoins : faCreditCard} 
                                                className={`mr-2 ${invoice.transaction.payment_method === 'Bee Points' ? 'text-yellow-500' : 'text-blue-500'}`} 
                                            />
                            ...
                            <div className="mb-8">
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <div className="flex items-start">
                                        <FontAwesomeIcon icon={faPalette} className="text-purple-500 mr-3 mt-1" />
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="font-medium">
                                                                {invoice.transaction.payment_method === 'Bee Points' ? 
                                                                    `${invoice.theme.price} EZ$` : 
                                                                    `$${invoice.theme.price}`
                                                                }
                                                            </p>
                                                        </div>
                                                        {invoice.theme.description && (
                                                            <div className="md:col-span-2">
                                                                ...
                                                                <p className="font-medium">{invoice.theme.description}</p>
                                                            </div>
                                                        )}
                                                    </div>
                                                </>
                                            ) : (
                                                <p className="text-gray-500">Theme details not available</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mb-8">
                                <h2 className="text-lg font-medium text-gray-900 mb-4">Purchase Details</h2>
